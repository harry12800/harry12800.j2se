...
class FristPageItem<T> extends JButton {
	/**
	* 
	*/
	...
	public FristPageItem(final PagePanel<T> pagePanel, int index) {
		super("首页");
		this.index = index;
		...
		addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				pagePanel.selectIndex(FristPageItem.this.index);
			}
		});
